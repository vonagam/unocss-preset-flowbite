...
import toSvgUri from 'mini-svg-data-uri';

export declare namespace presetFlowbite {
  type Options = {
    forms?: boolean,
    tooltips?: boolean,
  };
...
export const presetFlowbite = (options: presetFlowbite.Options = {}): Preset => {
  const {forms = true, tooltips = true} = options;
  ...
  return {
    ...
    preflights: [{
      getCSS: (context) => {
        ...
        const spacing = (index: number) => theme.spacing[index] || `${0.25 * index}rem`;
        ...
        if (forms) {
          results.push(`
            ...
            select:not([size]) {
              background-image: url("${toSvgUri(
                `<svg aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 10 6">
                  <path stroke="${theme.colors.gray['500']}" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m1 1 4 4 4-4"/>
                </svg>`
              )}");
            ...
            input[type='range']:focus::-webkit-slider-thumb {
              ...
              outline-offset: 2px;
              --un-ring-offset-shadow: var(--un-ring-inset) 0 0 0 var(--un-ring-offset-width) var(--un-ring-offset-color);
              --un-ring-shadow: var(--un-ring-inset) 0 0 0 calc(4px + var(--un-ring-offset-width)) var(--un-ring-color);
              box-shadow: var(--un-ring-offset-shadow), var(--un-ring-shadow), var(--un-shadow, 0 0 #0000);
              --un-ring-opacity: 1;
              --un-ring-color: rgb(164 202 254 / var(--un-ring-opacity));
            }
            ...
            .toggle-bg:after {
              ...
              box-shadow: var(--un-ring-inset) 0 0 0 calc(0px + var(--un-ring-offset-width)) var(--un-ring-color);
            }
